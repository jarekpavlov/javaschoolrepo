...
<div class="container" style="margin-top: 1.5em">
    <div class="row" style="float: right; margin-bottom: 1.5em; margin-right: 1.5em">
        <%@ include file="fragments/cartInformation.jspf" %>
    </div>
    <c:if test="${clientFailure != null}">
        <div class="alert alert-danger" role="alert">${clientFailure}</div>
    </c:if>
    ...
    <c:if test="${clientInformation != null}">
        <div style="margin-top: 1em" class="alert alert-danger" role="alert">${clientInformation}</div>
    </c:if>
    <c:if test="${clientSuccess != null}">
        <div style="margin-top: 1em" class="alert alert-success" role="alert">${clientSuccess}</div>
    </c:if>
                ...
                <form:form action="/MmsPr/users/registration/save/" method="post" modelAttribute="client"  >
                    ...
                    <sec:authorize access="isAnonymous()">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 col-md-10">
                                <input class="form-control" required="required" minlength="2" maxlength="40" id = "password" type="password" name="password"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="repeatPassword" class="col-sm-3 col-md-2 col-form-label">Repeat Password:</label>
                            <div class="col-sm-9 col-md-10">
                                <input class="form-control" required="required" minlength="2" maxlength="40" id = "repeatPassword" type="password" name="repeatPassword"/>
                            </div>
                        </div>
                    </sec:authorize>
                    <div class="row">
